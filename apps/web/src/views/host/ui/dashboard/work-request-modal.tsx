...
export function WorkRequestModal({
  ...
  const t = useTranslations('host.operations.workRequestModal');
      ...
      <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl w-full max-w-[420px] max-h-[90vh] overflow-y-auto">
          ...
          <div className="px-5 pb-5">
            {/* Guide Section */}
            <div className="mb-4">
              <p className="text-sm text-[hsl(var(--snug-orange))] mb-2">{t('notice')}</p>
              {isServiceDay ? (
                <p className="text-sm text-[hsl(var(--snug-text-primary))]">
                  {t('todayServiceVisit')}
                  <br />
                  {t('pressCompleteWhenDone')}
                </p>
              ) : (
                <p className="text-sm text-[hsl(var(--snug-text-primary))]">
                  {t('managerWillVisit', { date: data.scheduledDate })}
                </p>
              )}
            </div>
            ...
            {isServiceDay && data.additionalRequest && (
              <div className="mb-6">
                <p className="text-sm text-[hsl(var(--snug-orange))] mb-2">
                  {t('additionalRequest')}
                </p>
