  ...
  return (
    ...
    >
      ...
      <div className="w-12 flex justify-end">
        {badge && (
          <span className="text-xs text-[hsl(var(--snug-gray))] bg-[hsl(var(--snug-light-gray))] px-2 py-0.5 rounded-full">
            {badge}
          </span>
        )}
      </div>
...
function KakaoIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24">
      <path
        fill="#3C1E1E"
        d="M12 3C6.48 3 2 6.48 2 10.5c0 2.52 1.67 4.73 4.17 6.02-.13.47-.84 3.04-.87 3.26-.03.28.1.28.22.2.09-.06 3.47-2.35 3.92-2.66.85.12 1.73.18 2.56.18 5.52 0 10-3.48 10-7.5S17.52 3 12 3z"
      />
    </svg>
  );
}
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center gap-4 py-2">
        <div className="flex-1 border-t border-[hsl(var(--snug-border))]" />
        <span className="text-sm text-[hsl(var(--snug-gray))]">or</span>
        <div className="flex-1 border-t border-[hsl(var(--snug-border))]" />
      </div>
